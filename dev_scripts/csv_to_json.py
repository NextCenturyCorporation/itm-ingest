        ...
        with open(csv_file_path, 'r', newline='', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                if  eventname == "PATIENT_RECORD":
                    ...
                    img_entry = {
                        "name": patient_name,
                        "filename": f"{GsessionId}_{GparticipantId}_{patient_name}.jpg"
                    }
                    
                    Gimg_data.append(img_entry)
        ...
        # Handle INJURY_TREATED events
            ...
            if treatment != 'none':
                ...
                treatment_action = {
                    ...
                    "answer": "",
                    "movedBeforeClearedByCommand": False,
                    "timestamp": converted_timestamp  # Use converted timestamp
                }
...
def create_output_json(config_data, action_list, output_file_path):
    """Create output JSON file with config data and parsed CSV data"""
    
    h, rem = divmod(int(GElapsedTime) // 1000, 3600)
    m, s = divmod(rem, 60)
...
def main():
    ...
    global GparticipantId
    global GsessionId
    
    filename = os.path.basename(csv_file_path)
    name_without_ext = os.path.splitext(filename)[0]
    GsessionId, GparticipantId = name_without_ext.split("_")

    print("Session ID:", GsessionId)
    print("Participant ID:", GparticipantId)
    ...
    create_output_json(config_data, action_list, output_file_path)
